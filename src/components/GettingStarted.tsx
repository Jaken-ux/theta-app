    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <Section title="Buy THETA or TFUEL" step={1} color="#2AB8E6">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-white mb-1.5">Major exchanges</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
            ...
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-white mb-1.5">Good to know</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
        ...
        <Section title="Set up a wallet" step={2} color="#10B981">
          ...
          <div className="space-y-3">
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-white mb-1.5">Official Theta Wallet</p>
              <p className="text-xs text-[#B0B8C4] leading-relaxed">
            ...
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-white mb-1.5">Hardware wallet (cold storage)</p>
              <p className="text-xs text-[#B0B8C4] leading-relaxed">
        ...
        <Section title="Stake and earn" step={3} color="#F59E0B">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-[#2AB8E6] mb-1.5">THETA → Guardian Node</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
            ...
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-[#10B981] mb-1.5">TFUEL → Elite Edge Node</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
        ...
        <Section title="Stay safe" step={4} color="#EF4444">
          <div className="space-y-3">
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-white mb-1.5">Protect your keys</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
            ...
            <div className="bg-[#0D1117] rounded-lg p-3">
              <p className="text-xs font-medium text-[#EF4444] mb-1.5">Common scams to avoid</p>
              <ul className="space-y-1 text-xs text-[#B0B8C4]">
      ...
      <div className="bg-[#0D1117] border border-[#2A3548] rounded-xl p-4">
        <p className="text-xs font-medium text-white mb-2">Official resources</p>
        <div className="grid sm:grid-cols-2 gap-x-6 gap-y-1 text-xs text-[#B0B8C4]">
