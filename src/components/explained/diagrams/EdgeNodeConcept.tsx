export default function EdgeNodeConcept() {
  return (
    <svg viewBox="0 0 400 300" fill="none" className="w-full max-w-[400px]">
      {/* Computer */}
      <rect x="130" y="40" width="140" height="100" rx="12" fill="#151D2E" stroke="#2AB8E6" strokeWidth="1.5" />
      ...
      {/* Base */}
      <rect x="170" y="144" width="60" height="6" rx="3" fill="#445064" />
      ...
      {[
        ...
        <g key={i}>
          ...
          <circle cx={item.x} cy={item.y} r="24" fill="#151D2E" stroke="#2AB8E6" strokeWidth="1" />
