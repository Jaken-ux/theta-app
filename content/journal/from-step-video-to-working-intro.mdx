...
![First test output — 3 seconds, 72 frames](/images/journal/stepvideo_short_cover.png)
...
Remotion handles all of that. One reusable Intro component takes width, height, and fps as props. Same component, three renders, three aspect ratios. The Step Video source file is the same across all three — Remotion reframes the same input differently for each canvas using `object-fit: cover`, so there are no black bars regardless of aspect-ratio mismatch. The logo entrance and fade-out are identical across all three.

Vertical (9:16) for Instagram Reels, TikTok, YouTube Shorts:

<video controls preload="metadata" playsInline poster="/images/journal/stepvideo_long_cover.png">
  <source src="/videos/IntroPreview9x16.mp4" type="video/mp4" />
</video>

Horizontal (16:9) for YouTube and X:
...
<video controls preload="metadata" playsInline poster="/images/journal/stepvideo_long_cover.png">
  <source src="/videos/IntroPreview1x1.mp4" type="video/mp4" />
</video>
